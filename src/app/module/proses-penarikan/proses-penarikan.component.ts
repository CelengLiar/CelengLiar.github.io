...
const TYPE = 'Withdraw';
@Component({
  selector: 'app-proses-penarikan',
  templateUrl: './proses-penarikan.component.html',
  styleUrls: ['./proses-penarikan.component.css'],
})
export class ProsesPenarikanComponent implements OnInit {
  displayedColumns = [
    'status',
    'name',
    'amount',
